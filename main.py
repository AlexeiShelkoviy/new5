...
class Pet:
    def __init__(self, species="dog", name="Arkasha", hunger=50, happiness=50):
    ...
    def __str__(self):
        return f"{self.name} is a {self.species}, Hunger:{self.hunger}, Happiness:{self.happiness}"
...
brands_of_car = {
    ...
    "Ford":{"fuel":75, "strength":125, "consumption": 25},
    "Toyota":{"fuel":80, "strength":120, "consumption": 14},
    "Alfa Romeo":{"fuel":75, "strength":85, "consumption": 5}
        }
class House:
    def __init__(self):
        self.mess = 0
...
job_list = {
    ...
    "Graphic Designer":
    {"salary":75, "gladness_less": 5 },
    "Mac worker":
    {"salary":47, "gladness_less": 10 },
    "Cleaner":
    {"salary":50, "gladness_less": 10 },
        }
